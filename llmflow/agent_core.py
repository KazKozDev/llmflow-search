...
Manages the flow of information and decision making using GPT-4o-mini.
"""
import logging
import time
import json
...
class AgentCore:
    def __init__(self, memory, planning, tools, report_generator, llm_service, max_iterations=5):
        """
