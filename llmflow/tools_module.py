...
try:
    from .duckduckgo_searcher import DuckDuckGoSearcher, default_searcher
except ImportError:
    from duckduckgo_searcher import DuckDuckGoSearcher, default_searcher
...
class ToolsModule:
    ...
    def search_duckduckgo(self, query):
        ...
        try:
            ...
            if 'default_searcher' in globals() and default_searcher is not None:
    ...
    # Метод _fallback_search удален, так как теперь используется расширенный поисковый модуль
